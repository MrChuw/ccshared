...
import com.mrchuw.ccshared.lua.RecipesLuaAPI;
...
public class CCShared {
    ...
    public static void init() {
        ...
        if (!apiRegistered) {
            apiRegistered = true;
            ComputerCraftAPI.registerAPIFactory(computer -> new RecipesLuaAPI());
            LOGGER.info("[cc: Shared] Recipes Lua API registered as `recipes`.");
        }
    }
}